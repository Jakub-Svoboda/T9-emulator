...
function tnine(){
	...
	if(words[code]!=null){
		...
		str=str.replace(word,(words[code])[t9_counter%((words[code]).length)])
		document.getElementById("text").innerHTML=str
	}
}
function clicked_t9(){
